...
public class DDynamic implements Serializable {
			...
			case 25: // NPC
				if(this.SpielPanel.getCurrentLevel() == 0 && this.SpielPanel.getCurrentLevelSection() == 0 && this.qalready[0]==false){//Quest 1
				   this.quest[0]=JOptionPane.showOptionDialog(null, "Hoert mich an EDLER BURGER!",
			                  ...
			                  new String[]{"Schie�t los hei�er Hund!", "ICH AUF EINE NIEDERE SPEISE HOEREN?????!"}, "ICH AUF EINE NIEDERE SPEISE HOEREN?????!");
				   this.Quest1(quest[0]);
				}
	...
	*/
	...
	/**
	 * ein counter f�r DSound Magie etc.
	 * @param int p
	 * @return
	 */
	...
	public void Quest1(int p){
		if(p==JOptionPane.YES_OPTION){
		 this.qenabled[0]=JOptionPane.showOptionDialog(null, "\nENDLICH EIN EDLER SEINER ZUNFT! DIE SO�EN SOLLEN DIR IMMER HOLD SEIN..." +
		 		...
		 		"BITTE BEEILT EUCH!\n(fluestern: Natuerlich gibt es auch eine gro�e Belohnung...)",
